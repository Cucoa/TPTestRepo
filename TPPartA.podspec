#
# Be sure to run `pod lib lint TPPartA.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'TPPartA'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TPPartA.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'TPPartA/Classes/**/*'
  
  # s.resource_bundles = {
  #   'TPPartA' => ['TPPartA/Assets/*.png']
  # }
